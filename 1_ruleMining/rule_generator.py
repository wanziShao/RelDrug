...
def build_prompt(head, candidate_rels, is_zero, k):
    ...
    instruction = (
        "You are a medical professional. Logical rules define the relationship between two entities: X and Y. Each rule is written in the form "
...
def main(args, LLM):
    ...
    sampled_path = read_paths(os.path.join(sampled_path_dir, "rel_paths.jsonl"))
