...
def KGIN_data_loader(kg_triples, kg_voc, data_voc):
    ...
    adj_mat_list, norm_mat_list, mean_mat_list = build_sparse_relational_graph(relation_dict, rel2idx, n_nodes,
                                                                               n_leaf_nodes, n_entities)
...
def example_graph(kg_triple, kg_voc, voc, save_path, args):
    ...
    """
    diag2cui, proc2cui, med2cui, kg_voc, rel_voc = kg_voc['diag2cui'], kg_voc['proc2cui'], kg_voc['med2cui'], kg_voc[
        'kg2id'], kg_voc['rel2id']
